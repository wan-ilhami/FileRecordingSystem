...
if (!isset($_SESSION['USERLEVELID'])) {
    ...
    if($_SESSION['USERLEVELID'] == 1){
      header('location:../SystemAdmin/dashboard.php');
    }
...
<head>
    ...
    <title>FSPU File Recording System - My Profile</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4" style="width: 40%; margin:auto; display:block;">
                            ...
                            $sql = "SELECT * FROM ACCESSUSER a JOIN USERLEVEL b ON a.USERLEVELID=b.USERLEVELID JOIN USERS u ON a.USERID = u.USERID WHERE u.USERID= :ID ";
                            ...
                            <!-- SELECT * FROM SUBCODE a JOIN CODEFILE b ON a.CODEID=B.CODEID ORDER BY SUBCODEID ASC -->
                            <?php
                            ...
                            ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="jarakInput ">
                                            <label for="uname"><a>ID : <?php echo $row['USERID']; ?></a></label>
                                        </div>
                                        <hr class="sidebar-divider">
                                        <div class="jarakInput">
                                            <label for="uname"><a> Name : <?php echo $row['USERNAME']; ?></a></label>
                                        </div>
                                        <hr class="sidebar-divider">
                                        <div class="jarakInput">
                                            <label for="email"><a> Email : <?php echo $row['USEREMAIL']; ?></a></label>
                                        </div>
                                        <hr class="sidebar-divider">
                                        <div class="jarakInput " style="margin-bottom:20px;">
                                            <label for="User Level"><a>User Level : <?php echo $row['USERLEVELDESC']; ?></a></label>
                                        </div>

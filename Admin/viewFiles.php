...
<head>
  ...
  <title>FSPU File Recording System - View Files</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">FSPU File Directory</h1>
          <p class="mb-4"> </p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="addFile.php" class="btn btn-warning btn-icon-split">
                ...
                <table class="table table-bordered" id="fileTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    switch ($levelid) {
                      ...
                      case '4':
                        $sql = "SELECT * FROM CODEFILE a JOIN VIEWACCESS b ON a.VIEWID=b.VIEWID WHERE a.VIEWID=1 ORDER BY CODEID ASC ";
                        break;
                        // default : echo "<script language = 'javascript'> alert('You have entered Wrong Code'); window.location = 'SearchCode.php';</script>";
                      default:
                        $sql = "SELECT * FROM CODEFILE a JOIN VIEWACCESS b ON a.VIEWID=b.VIEWID WHERE a.VIEWID IN (1,2) ORDER BY CODEID ASC";
                        break;
                    }
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;"> <?php echo $row['CODEID']; ?> </td>
                          <td style="text-align: center;"> <?php echo $row['CODEDESC']; ?> </td>
                          <td style="text-align: center;"> <?php echo $row['VIEWDESC']; ?> </td>
                          <form action="viewDoc.php" method="POST">
                            <input type="hidden" name="codeID[]" id="codeID" value="<?php echo $row['CODEID']; ?>"> </input>
                            <td style="text-align: center;">
                              <button style="margin:auto; display:block;" class="btn btn-success btn-circle" type="submit" style="cursor: pointer;"><i class="fa fa-arrow-right"></i></button>
                            </td>
                          </form>
                          <form action="editFile.php" method="POST">
                            <input type="hidden" name="codeID[]" id="codeID" value="<?php echo $row['CODEID'] ?>">
                            <td>
                              <button style="margin:auto; display:block;" class="btn btn-info btn-circle" type="submit" style="cursor: pointer;"><i class="fa fa-edit"></i></button>
                            </td>
                          </form>
                        </tr>

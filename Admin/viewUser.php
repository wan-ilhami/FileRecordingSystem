...
<head>
  ...
  <title>FSPU File Recording System - View User</title>
      ...
      <div id="content">
       ...
       <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">User Directory</h1>
          <p class="mb-4"></p>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="userTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM ACCESSUSER a JOIN USERLEVEL b ON a.USERLEVELID=b.USERLEVELID JOIN USERS u ON a.USERID = u.USERID WHERE a.USERLEVELID IN (3,4) ORDER BY u.USERID ASC";
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;"> <?php echo $row['USEREMAIL']; ?> </td>
                          <td style="text-align: center;"> <?php echo $row['USERLEVELDESC']; ?> </td>
                          <form action="editUser.php" method="POST">
                          <td style="text-align: center;">
                            <button  class="btn btn-info btn-circle" type="submit" name="user" value="<?php echo $row['USERID']; ?>"><i class="fa fa-edit"></i></button>
                          </td>
                          </form>

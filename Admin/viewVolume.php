      ...
      <li class="nav-item active">
        ...
        <div id="collapseFiles" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="viewVolume.php">View Document</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Document Directory</h1>
          ...
          $sql = "SELECT * FROM SUBCODE a JOIN CODEFILE b ON a.CODEID=B.CODEID JOIN USERS c ON a.USERID=c.USERID WHERE VIEWID IN (1,2) ORDER BY SUBCODEID ASC";
                  ...
                  <tbody>
                    ...
                    ?>
                        ...
                        ?>
                          ...
                          <form action="deleteVolume.php" method="POST">

...
<head>
  ...
  <title>FSPU File Recording System - Add File</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseFiles" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="addFile.php">Add Files</a>
          </div>
        </div>
      </li>
          ...
          <div class="row">
            ...
            <div class="card shadow mb-4" style="width: 40%; margin:auto; display:block;">
              <div class="card-header py-3" style="text-align:center;">
                <h3>Add Files to your Directory</h3>
              </div>
              <div class="card-body">
                <form action="addFileP.php" method="POST">

                  <div>
                    <label style="margin-top: 30px; margin-left:10%;" for="uname"><b>File Code</b></label><br>
                    <input style="width:80%;margin:auto; display:block;" type="text" placeholder="Enter File Code" name="filecode" required>
                  </div>

                  <div>
                    <label style="margin-top: 30px; margin-left:10%;" for="uname"><b>File Name</b></label><br>
                    <input style="width:80%;margin:auto; display:block;" type="text" placeholder="Enter File Name" name="filedesc" required>
                  </div>
                  <input type="hidden" name="va" value="1">

                  <button class="btn btn-success btn-icon-split" type="submit" style="width: 40%; margin: auto; display: block; margin-top:9%;margin-bottom:5%;">Add File</button>

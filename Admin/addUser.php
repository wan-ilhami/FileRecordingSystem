...
<head>
    ...
    <title>FSPU File Recording System - Add User</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUser" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="addUser.php">Add User</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div style="margin-top:3%; " class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4" style="width: 40%; margin:auto; display:block;">
                            ...
                            <div class="card-body">
                                <form class="upload-form" action="addUserP.php" method="post">
                                    <h6 style="text-align:center;">
                                        Please enter the following details
                                    </h6>

                                    <div class="jarakInput">
                                        <label class="labelReg" for="ID"><b>Staff ID</b></label><br>
                                        <input class="inputBox" type="text" placeholder="Enter Staff ID" name="id" required>
                                    </div>

                                    <div class="jarakInput">
                                        <label class="labelReg" for="uname"><b>Staff Name</b></label><br>
                                        <input class="inputBox" type="text" placeholder="Enter Staff Name" name="name" required>
                                    </div>

                                    <div class="jarakInput">
                                        <label class="labelReg" for="email"><b>Staff Email</b></label><br>
                                        <input class="inputBox" type="text" placeholder="Enter Email" name="email" required>
                                    </div>

                                    <button class="btn btn-success btn-icon-split" style="width:50%; margin:auto; display:block; margin-top:30px; margin-bottom:10px;" type="submit">Add User</button>

...
<head>
    ...
    <title>FSPU File Recording System - Upload Document</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div style="margin-top:5%; " class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4" style="width: 40%; margin:auto; display:block;">
                            <div class="card-header py-3" style="text-align:center;">
                                <h3>Add Document to your Directory</h3>
                            </div>
                            <div class="card-body">
                                <form class="upload-form" action="uploadProcess.php" method="post" enctype="multipart/form-data">

                                    <label style="margin-left:25%;" for="codeID">File Directory Code</label><br>
                                    <input style="margin:auto; display:block; width:50%;" name="codeID" readonly placeholder="CodeID" value="<?php echo $c ?>" /><br>

                                    <input type="hidden" name="sub" placeholder="sub" value="1" /><br>

                                    <label style="margin-left:25%;" for="uploaddate">Document Date Issued</label><br>
                                    <input style="margin:auto; display:block; width:50%;" type="date" name="uploaddate" required /><br>

                                    <input style="margin:auto; display:block; margin-top:30px;" type="file" name="file[]" multiple="multiple" /><br>
                                    <input class="btn btn-success btn-icon-split" style=" margin:auto; display:block; margin-top:30px; width:50%;" type="submit" name="submit" value="Upload Document" />
                                </form>
                            </div>
                        </div>

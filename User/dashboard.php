      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php
            include("../connection.php");
            $sql_query = 'SELECT COUNT(CODEID) AS NUMFILE FROM CODEFILE WHERE VIEWID = 1';
            ...
            <?php
            include("../connection.php");
            $sql_query = 'SELECT COUNT(SUBCODEID) AS NUMDOC FROM SUBCODE a JOIN CODEFILE b ON a.CODEID=b.CODEID WHERE VIEWID = 1';
            ...
            <div style="width:98%; margin:auto; display:block;">
              <div class="card shadow mb-4 " style="width:100%;">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">User Guide</h6>
                ...
                <div class="card-body" style="height:150px;">
                  <div class="chart-area">
                    ...
                    $sql = "SELECT * FROM SUBCODE WHERE SUBCODEDESC LIKE 'NORMAL USER MANUAL.PDF'";

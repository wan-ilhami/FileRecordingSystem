      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div style="margin-top:2%;" class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">System Admin Dashboard</h1>
          </div>
          ...
          <div class="row">
            ...
            <?php
            include("../connection.php");
            $sql_query = 'SELECT COUNT(CODEID) AS NUMFILE FROM CODEFILE';
            ...
            include("../connection.php");
              //##########ENCRYPTING DOC_ID#############*/
                        ...
                        //##########ENCRYPTING DOC_ID#############*/
            $sql_query = 'SELECT COUNT(SUBCODEID) AS NUMDOC FROM SUBCODE';
            ...
            <?php
            include("../connection.php");
            $sql_query = 'SELECT COUNT(USERID) AS USERNUM FROM USERS';
            ...
            <div style="width:98%; margin:auto; display:block; ">
              <div class="card shadow mb-4 " style="width:100%; ">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-dark">System Admin User Guide</h6>
                ...
                <div class="card-body" style="height:450px;">
                  <div class="chart-area">
                    ...
                    $sql =  "SELECT * FROM SUBCODE a JOIN CODEFILE b ON a.CODEID=b.CODEID WHERE VIEWID=3" ;
                              ...
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  ...
                                  <div class="h5 mb-0 font-weight-bold text-gray-800">
                                       <?php $doc_name = explode('@', $row['SUBCODEDESC']);
                        $string = $row['SUBCODEID'];
                        $encryption = openssl_encrypt($string, $ciphering, 
                                        $encryption_key, $options, $encryption_iv);
                        echo "<a target='_blank' href='../view.php?id=" .$encryption."'>". $row['SUBCODEDESC'] ."</a>";
                          ?>
                                    </div>
                                </div>
                                <div class="col-auto">

                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card shadow mb-4" style="width: 40%; margin:auto; display:block;">
                            ...
                            include('../connection.php');
                            $a = $_POST['user'];
                            $sql = "SELECT * FROM USERS a JOIN ACCESSUSER b ON a.USERID = b.USERID WHERE b.USERID=:a ";
                            ...
                            ?>
                                    ...
                                    <div class="card-body">
                                        <form action="editUserProcess.php" method="post" class="editform">
                                            ...
                                            <hr class="sidebar-divider">
                                            <div class="jarakInput">
                                                <label for="see"><a>Staff access ID : <?php echo $_SESSION['ACCESSID']=$row['ACCESSID']; ?></a></label>
                                            </div>
                                            <hr class="sidebar-divider">
                                            <div style="margin-top:30px;">
                                                ...
                                                <table>
                                                    ...
                                                    <input class="jarakInput" type="radio" id="400" name="level" value="1">
                                                    <label for="HLU" style="margin-left: 20px;"> 1-System Admin</label><br>

                                                    <input type="radio" id="100" name="level" value="2">
                                                    <label for="HLU" style="margin-left: 20px;"> 2-Admin</label><br>

                                                    <input type="radio" id="200" name="level" value="3">
                                                    <label for="HLU" style="margin-left: 20px;"> 3-Moderator</label><br>

                                                    <input type="radio" id="300" name="level" value="4">
                                                    <label for="HLU" style="margin-left: 20px;"> 4-Normal User</label><br>
